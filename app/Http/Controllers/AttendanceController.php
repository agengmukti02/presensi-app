...
class AttendanceController extends Controller
{
    ...
    private function pegawaiDashboard(Request $request)
    {
        ...
        // Filter data employee untuk keamanan - hanya kirim yang perlu ditampilkan
        $employeeData = [
            'id' => $employee->id,
            'nama' => $employee->nama,
            // NIP, email, dan data sensitif lainnya TIDAK dikirim ke frontend
            // untuk mencegah exposure di inspect element
        ];
        ...
        return \Inertia\Inertia::render('Dashboard/PegawaiDashboard', [
            ...
            'todayAttendance' => $todayAttendance ? [
                ...
                // Data sensitif seperti ID, employee_id tidak dikirim
            ] : null,
