...
export default function PresensiAdmin({ days = [], rows = [], currentMonth, currentYear, employees = [], selectedEmployeeId = null }) {
    ...
    const handleFilterChange = () => {
        ...
        router.visit(`/presensi/admin?${params.toString()}`, {
            preserveState: false,
        });
    };
    ...
    return (
        <DashboardLayout>
            ...
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-800">Data Presensi Pegawai</h2>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div className="flex gap-2">
                    <a
                        href={`/api/attendances/export/excel/${month}/${year}${employeeId ? '?employee_id=' + employeeId : ''}`}
                        target="_blank"
                    ...
                    <a
                        href={`/api/attendances/export/pdf/${month}/${year}${employeeId ? '?employee_id=' + employeeId : ''}`}
                        target="_blank"
