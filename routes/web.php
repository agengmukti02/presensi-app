...
Route::middleware(['auth', 'role:pegawai'])->group(function () {
    ...
    // Export presensi individual pegawai
    Route::get('/api/attendances/export/excel/pegawai/{month}/{year}', [ExportController::class, 'exportExcelPegawai'])->name('export.excel.pegawai');
    Route::get('/api/attendances/export/pdf/pegawai/{month}/{year}', [ExportController::class, 'exportPdfPegawai'])->name('export.pdf.pegawai');
});
